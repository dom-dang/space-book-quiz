...
function updateResults() {
  if (skywardScore >= 2) {
    ...
    results.innerHTML =
      "I recommend The Fountains of Silence by Ruta Sepetys! <br><span class='rec'>A beautiful story of opression, love, and secrets in Madrid, under the fascist distatorship of General Francisco Franco. 18 year old Daniel Matheson, the son of a privileged tycoon, traveled to Spain to reconnect with his mother's birth country and found someone who is as intriguing as Madrid is dangerous. </span>";
  } else if (americanScore >= 2) {
    results.innerHTML =
      "I recommend American Street by Ibi Zoboi!<br><span class='rec'> On American Street, Fabiola Toussaint thought she was on the way to a good life. But as her and her family leave Haiti, her mother is detained by US immigration and she is left with her American family. Tackling unusual friends, odd cousins, and a new school, she finds herself at an internal crossroad about the American Dream.</span>";
  } else if (beautifulScore >= 2) {
    results.innerHTML =
      "I recommend The Beautiful by Renée Ahdieh!<br><span class='rec'>Celine Rouseeau has found escape from her past in New Orleans, a city ruled by the dead. Twirling into the mysterious, glamorous city, Celine gets entailed in the underworld with the enigmatic Sebastien Saint Germain. Suddenly, one of her friends is murdered but as Celine is solving the mystery, she discovered an age-old feud that could disrupt all of New Orleans. </span>";
  } else {
